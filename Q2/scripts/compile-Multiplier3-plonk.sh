...
# snarkjs zkey contribute Multiplier3_plonk/circuit_0000.zkey Multiplier3_plonk/circuit_final.zkey --name="Yo!" -v -e="my random text"
...
snarkjs zkey export solidityverifier Multiplier3_plonk/circuit_0000.zkey ../Multiplier3_plonkVerifier.sol
